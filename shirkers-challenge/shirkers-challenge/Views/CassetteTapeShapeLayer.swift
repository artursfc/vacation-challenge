...
class CassetteTapeShapeLayer: CAShapeLayer {
    ...
    public func overlayedOutlinePath(view: UIView) {
        ...
        overlayedOutlinePath.move(to: CGPoint(x: view.center.x - (2.5 * Dimensions.cassetteTapeWidthConstant), y: 2.7 * Dimensions.cassetteTapeWidthConstant))
        overlayedOutlinePath.addLine(to: CGPoint(x: view.center.x - (2.5 * Dimensions.cassetteTapeWidthConstant), y: Dimensions.cassetteTapeHeight))
        ...
        overlayedOutlinePath.addLine(to: CGPoint(x: view.center.x - (2.8 * Dimensions.cassetteTapeWidthConstant), y: Dimensions.cassetteTapeHeight))
